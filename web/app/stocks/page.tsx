    ...
    <div className="space-y-8">
      <header className="space-y-3 max-w-3xl">
        ...
        <p className="text-ink-600 text-[15px] leading-relaxed">
          Søk og filtrér i hele small-cap-universet, eller bytt til sammenligning
          for å plotte flere selskaper i samme prisgraf — normalisert til 100 ved
          startdato og valgfritt i NOK eller lokal valuta.
        </p>
      </header>

      <div className="inline-flex border hairline rounded-md overflow-hidden text-[13px]">
        <button
